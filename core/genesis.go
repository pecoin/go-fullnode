...
func SetupGenesisBlock(db pecdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil)
}

func SetupGenesisBlockWithOverride(db pecdb.Database, genesis *Genesis, overrideBerlin *big.Int) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db pecdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db pecdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db pecdb.Database) *types.Block {
...
func GenesisBlockForTesting(db pecdb.Database, addr common.Address, balance *big.Int) *types.Block {
...
// DeveloperGenesisBlock returns the 'fullnode --dev' genesis block.
