...
import (
	...
	"github.com/pecoin/go-fullnode/crypto/blake2b"
	"github.com/pecoin/go-fullnode/crypto/bls12381"
	"github.com/pecoin/go-fullnode/crypto/bn256"
...
func (c *ecrecover) Run(input []byte) ([]byte, error) {
	...
	return common.LeftPadBytes(crypto.Keccak256(pubKey[1:])[7:], 32), nil
}
