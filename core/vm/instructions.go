...
func opBalance(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	address := common.BytesToAddress(slot.PaddedBytes(common.AddressLength))
...
func opExtCodeSize(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	slot := callContext.stack.peek()
	slot.SetUint64(uint64(interpreter.evm.StateDB.GetCodeSize(common.BytesToAddress(slot.PaddedBytes(common.AddressLength)))))
	return nil, nil
}
...
func opExtCodeCopy(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	addr := common.BytesToAddress(a.PaddedBytes(common.AddressLength))
...
func opCall(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	toAddr := common.BytesToAddress(addr.PaddedBytes(common.AddressLength))
...
func opSuicide(pc *uint64, interpreter *EVMInterpreter, callContext *callCtx) ([]byte, error) {
	...
	interpreter.evm.StateDB.AddBalance(common.BytesToAddress(beneficiary.PaddedBytes(common.AddressLength)), balance)
