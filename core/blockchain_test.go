...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (pecdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (pecdb.Database, func()) {
...
//
// https://github.com/pecoin/go-fullnode/pull/15941
...
//
// Details at:
//  - https://github.com/pecoin/go-fullnode/issues/18977
//  - https://github.com/pecoin/go-fullnode/pull/18988
