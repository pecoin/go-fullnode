...
func NewTable(db pecdb.Database, prefix string) pecdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) pecdb.Iterator {
...
func (t *table) NewBatch() pecdb.Batch {
...
func (b *tableBatch) Replay(w pecdb.KeyValueWriter) error {
