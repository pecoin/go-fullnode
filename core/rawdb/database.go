...
import (
	...
	"github.com/pecoin/go-fullnode/pecdb/leveldb"
...
func NewDatabase(db pecdb.KeyValueStore) pecdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db pecdb.KeyValueStore, freezer string, namespace string) (pecdb.Database, error) {
...
func NewMemoryDatabase() pecdb.Database {
...
func NewMemoryDatabaseWithCap(size int) pecdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (pecdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (pecdb.Database, error) {
...
func InspectDatabase(db pecdb.Database, keyPrefix, keyStart []byte) error {
