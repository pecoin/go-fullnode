...
// account array.
func checkStateAccounts(t *testing.T, db pecdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db pecdb.Database, root common.Hash) error {
...
func checkStateConsistency(db pecdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(pecdb.Database), srcRoot)
