...
func wipeSnapshot(db pecdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db pecdb.KeyValueStore) error {
...
func wipeKeyRange(db pecdb.KeyValueStore, kind string, prefix []byte, keylen int) error {
