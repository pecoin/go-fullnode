...
func generateSnapshot(diskdb pecdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, wiper chan struct{}) *diskLayer {
...
func journalProgress(db pecdb.KeyValueWriter, marker []byte, stats *generatorStats) {
...
func (dl *diskLayer) generate(stats *generatorStats) {
	...
	for accIt.Next() {
		...
		if batch.ValueSize() > pecdb.IdealBatchSize || abort != nil {
