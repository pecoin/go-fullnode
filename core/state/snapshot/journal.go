...
func loadAndParseLegacyJournal(db pecdb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadAndParseJournal(db pecdb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadSnapshot(diskdb pecdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, recovery bool) (snapshot, error) {
