...
!define HELPURL "https://github.com/pecoin/go-fullnode/issues"
!define UPDATEURL "https://github.com/pecoin/go-fullnode/releases"
!define ABOUTURL "https://github.com/pecoin/go-fullnode#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:21861)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:21861)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:21861)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:21861)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 21861 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:21861)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 21861 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:21861)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 21861 "" ""
