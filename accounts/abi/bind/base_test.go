...
func (mc *mockCaller) CallContract(ctx context.Context, call fullnode.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call fullnode.CallMsg) ([]byte, error) {
