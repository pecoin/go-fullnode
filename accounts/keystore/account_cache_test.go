...
var (
	...
	cachetestAccounts = []accounts.Account{
		{
			Address: common.Base58ToAddress("Pt4Pbr3QKpYFR5KwKd345nzXLdHHcqjT69"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(cachetestDir, "UTC--2021-04-25T05-15-03.688502000Z--Pt4Pbr3QKpYFR5KwKd345nzXLdHHcqjT69.json")},
		},
		{
			Address: common.HexToAddress("PrBzadskTSeeHgjrtsQuhsRixi1o2m6wXM"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(cachetestDir, "aaa")},
		},
		{
			Address: common.HexToAddress("Pc9GKzp8XoPpxGSSmAZRYXLFmzFEfbBmrF"),
...
func TestWatchNoDir(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("pec-keystore-watch-test-%d-%d", os.Getpid(), rand.Int()))
