...
func makeHeaderChain(parent *types.Header, n int, db pecdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (pecdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() pecdb.Database {
	return odr.db
}
