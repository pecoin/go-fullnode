...
func (pre *Prestate) Apply(vmConfig vm.Config, chainConfig *params.ChainConfig,
	...
	// If DAO is supported/enabled, we need to handle it here. In fullnode 'proper', it's
...
func MakePreState(db pecdb.Database, accounts core.GenesisAlloc) *state.StateDB {
