...
var (
	walletCommand = cli.Command{
		...
		Description: `
    fullnode wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	fullnode wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    fullnode account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    fullnode account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    fullnode account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    fullnode account import [options] <keyfile>
...
func unlockAccount(ks *keystore.KeyStore, address string, i int, passwords []string) (accounts.Account, string) {
	...
	for trials := 0; trials < 3; trials++ {
		...
		if err == nil {
			...
			log.Info("Unlocked account", "address", account.Address.Base58())
