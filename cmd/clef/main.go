...
import (
	...
	"github.com/pecoin/go-fullnode/signer/core"
	"github.com/pecoin/go-fullnode/signer/fourbyte"
	"github.com/pecoin/go-fullnode/signer/rules"
	"github.com/pecoin/go-fullnode/signer/storage"
...
var (
	...
	chainIdFlag = cli.Int64Flag{
		...
		Usage: "Chain id to use for signing (1=mainnet, 2=testnet)",
	}
...
func setCredential(ctx *cli.Context) error {
	...
	if common.IsBase58Address(addr) {
		utils.Fatalf("Invalid address specified: %s", addr)
	}
	address := common.Base58ToAddress(addr)
	...
	pwStorage.Put(address.Base58(), password)
...
func checkFile(filename string) error {
	...
	// https://github.com/pecoin/go-fullnode/issues/20123
