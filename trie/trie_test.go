...
func (s *spongeDb) NewBatch() pecdb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) pecdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w pecdb.KeyValueWriter) error { return nil }
