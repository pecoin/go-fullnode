...
type Database struct {
	diskdb pecdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb pecdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb pecdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() pecdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch pecdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
