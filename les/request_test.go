...
type accessTestFn func(db pecdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db pecdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db pecdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db pecdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db pecdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
