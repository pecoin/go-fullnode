...
import (
	...
	"github.com/pecoin/go-fullnode/les/vflux"
	vfc "github.com/pecoin/go-fullnode/les/vflux/client"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightEthereum, error) {
	chainDb, err := stack.OpenDatabase("lightchaindata", config.DatabaseCache, config.DatabaseHandles, "pec/db/chaindata/")
	if err != nil {
		return nil, err
	}
	lesDb, err := stack.OpenDatabase("les.client", 0, 0, "pec/db/lesclient/")
	if err != nil {
		return nil, err
	}
