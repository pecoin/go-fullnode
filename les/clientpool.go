...
import (
	...
	"github.com/pecoin/go-fullnode/les/utils"
	"github.com/pecoin/go-fullnode/les/vflux"
	vfs "github.com/pecoin/go-fullnode/les/vflux/server"
...
func newClientPool(ns *nodestate.NodeStateMachine, lesDb pecdb.Database, minCap uint64, connectedBias time.Duration, clock mclock.Clock, removePeer func(enode.ID), synced func() bool) *clientPool {
	pool := &clientPool{
		ns:                  ns,
