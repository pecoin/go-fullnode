...
const (
	...
	ethVersion        = 64              // equivalent pec version for the downloader
...
func newServerHandler(server *LesServer, blockchain *core.BlockChain, chainDb pecdb.Database, txpool *core.TxPool, synced func() bool) *serverHandler {
