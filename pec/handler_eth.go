...
// ethHandler implements the pec.Backend interface to handle the various network
...
// RunPeer is invoked when a peer joins on the `pec` protocol.
...
func (h *ethHandler) Handle(peer *eth.Peer, packet eth.Packet) error {
	...
	default:
		return fmt.Errorf("unexpected pec packet type: %T", packet)
	}
}
