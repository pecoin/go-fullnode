...
import (
	...
	"github.com/pecoin/go-fullnode/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = pec.getBlock(pec.getTransaction(tx).blockHash);
  var genesis = pec.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.pec.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  pec.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
