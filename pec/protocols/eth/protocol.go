...
// ProtocolVersions are the supported versions of the `pec` protocol (first
// is primary).
...
const (
	...
	// Protocol messages overloaded in pec/65
...
// Packet represents a p2p message in the `pec` protocol.
type Packet interface {
	Name() string // Name returns a string corresponding to the message type.
	Kind() byte   // Kind returns the message type.
}

// StatusPacket is the network packet for the status message for pec/64 and later.
...
// GetBlockHeadersPacket represents a block header query over pec/66
...
// BlockHeadersPacket represents a block header response over pec/66.
...
// GetBlockBodiesPacket represents a block body query over pec/66.
...
// BlockBodiesPacket is the network packet for block content distribution over pec/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over pec/66
...
// GetNodeDataPacket represents a trie node data query over pec/66.
...
// NodeDataPacket is the network packet for trie node data distribution over pec/66.
...
// GetReceiptsPacket represents a block receipts query over pec/66.
...
// ReceiptsPacket is the network packet for block receipts distribution over pec/66.
...
// ReceiptsPacket66 is the pec-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket is the network packet for transaction distribution over pec/66.
...
// PooledTransactionsRLPPacket66 is the pec/66 form of PooledTransactionsRLPPacket
