...
// Peer is a collection of relevant information we have about a `pec` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `pec` protocol version.
...
// ReplyPooledTransactionsRLP is the pec/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the pec/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the pec/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the pec/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the pec/66 response to GetReceipts.
