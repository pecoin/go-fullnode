...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(fullnode.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
type FilterCriteria fullnode.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(fullnode.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
