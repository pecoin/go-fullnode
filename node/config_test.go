...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "fullnode.ipc", false, filepath.Join(os.TempDir(), "fullnode.ipc")},
		{"data", "fullnode.ipc", false, "data/fullnode.ipc"},
		{"data", "./fullnode.ipc", false, "./fullnode.ipc"},
		{"data", "/fullnode.ipc", false, "/fullnode.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "fullnode.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "fullnode.ipc", true, `\\.\pipe\geth.ipc`},
