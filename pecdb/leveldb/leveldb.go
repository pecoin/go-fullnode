...
func (db *Database) NewBatch() pecdb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) pecdb.Iterator {
...
func (b *batch) Replay(w pecdb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  pecdb.KeyValueWriter
	failure error
}
