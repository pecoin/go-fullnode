...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db pecdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db pecdb.Database) error {
